function __global_object_depths() {
	...
	global.__objectDepths[0] = 0; // obj_laz_stand
	global.__objectDepths[1] = 0; // obj_laz_right
	global.__objectDepths[2] = 0; // obj_laz_left
	global.__objectDepths[3] = 0; // obj_laz_jump_right
	global.__objectDepths[4] = 0; // obj_laz_jump_left
	global.__objectDepths[5] = 0; // obj_laz_squished
	...
	global.__objectNames[0] = "obj_laz_stand";
	global.__objectNames[1] = "obj_laz_right";
	global.__objectNames[2] = "obj_laz_left";
	global.__objectNames[3] = "obj_laz_jump_right";
	global.__objectNames[4] = "obj_laz_jump_left";
	global.__objectNames[5] = "obj_laz_squished";
